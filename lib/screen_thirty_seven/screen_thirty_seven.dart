...
class ScreenThirtySeven extends StatefulWidget {
  const ScreenThirtySeven({super.key});

  @override
  State<ScreenThirtySeven> createState() => _ScreenThirtySevenState();
}

class _ScreenThirtySevenState extends State<ScreenThirtySeven> {
  @override
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(
                    ...
                    fontWeight: FontWeight.w600),
                suffixIcon:
                const Icon(Icons.contact_phone_rounded, color: Colors.amber, size: 30),
                contentPadding:
                const EdgeInsets.symmetric(horizontal: 25, vertical: 20),
                enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(50),
